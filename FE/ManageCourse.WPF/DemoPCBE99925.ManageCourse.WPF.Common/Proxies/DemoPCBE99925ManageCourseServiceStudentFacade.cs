...
namespace EG.DemoPCBE99925.ManageCourse.WPF.Proxies;

[Export, Scoped]
public class DemoPCBE99925ManageCourseServiceStudentFacade
{
    public DemoPCBE99925ManageCourseServiceStudentFacade(IOptionsMonitor<SimpleKeyValueSettings> optionsSettings,
