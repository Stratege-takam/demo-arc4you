...
try
{
	...
	// Creation of the DbContext with pooling of the connection => higher performance, BE scenario.
	services.AddDbContextPool<EG.DemoPCBE99925.ManageCourseService.Database.DatabaseContext>(optionsBuilder =>
	{
