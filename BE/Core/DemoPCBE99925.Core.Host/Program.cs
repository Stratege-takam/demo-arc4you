...
using EG.DemoPCBE99925.Core.Host.HealthChecks;
using EG.DemoPCBE99925.Core.Host.Infrastructure;
...
Log.Information("Starting up DemoPCBE99925.Core.");
...
;
    ...
    services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies().Where(a => a.FullName is not null && a.FullName.StartsWith("DemoPCBE99925.Core")));
